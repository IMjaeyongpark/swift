...
class ViewController: UIViewController {
    ...
    func showAlter(messege : String){
        
        let alter = UIAlertController(title: nil, message: messege, preferredStyle: .alert)
