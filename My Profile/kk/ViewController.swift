...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        user_image.layer.shadowColor = UIColor.black.cgColor
        /// 현재 shadow는 view의 layer 테두리와 동일한 위치로 있는 상태이므로 offset을 통해 그림자를 이동시켜야 표출
        user_image.layer.shadowOffset = CGSize(width: 4, height: 4)
        /// shadow의 투명도 (0 ~ 1)
        user_image.layer.shadowOpacity = 0.8
        /// shadow의 corner radius
        user_image.layer.shadowRadius = 5.0
